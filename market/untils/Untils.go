...
func HttpGetRequest(strUrl string, mapParams map[string]string) string {
	...
	req := httplib.Get(strRequestUrl)
	req.Header("User-Agent", "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/39.0.2171.71 Safari/537.36")
...
// return: 请求结果
func OldHttpGetRequest(strUrl string, mapParams map[string]string) string {
